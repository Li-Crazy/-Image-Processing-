...
# highpass filter is Convolution1_pulsenoise
    ...
    lowmask[rows//2-80:rows//2+80,cols//2-80:cols//2+80] = 1
...
# pass filter
    ...
    mask2[rows // 2 - 100:rows // 2 + 100, cols // 2 - 100:cols // 2 + 100] = 1
    mask = mask1 * mask2
    f3 = filterf * mask
...
if __name__ == '__main__':
    ...
    display("PepperandSalt",1,[img1])
    curimg = cross5x5(img1)
    display('Medianfilter',1,[curimg])
